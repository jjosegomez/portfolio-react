        ...
        <>
            <div className="about">
                ...
                <div className="about-text">
                    <h1>Hey, I'm Juan!</h1>
                    <br />
                    <p>A dynamic Computer Science graduate from the University of South Florida dedicated to creating captivating web applications that bring innovative ideas to life. My expertise spans HTML, CSS, JavaScript, React, Node, and more, allowing me to craft seamless user experiences that make a lasting impact.</p>
                    ...
                    <p>🤖 These experiences, along with my stint at Microsoft where I honed leadership and communication skills through a mentorship program and contributed to an innovative Mixed Reality project using Microsoft Technologies, have been pivotal in my professional growth.</p>
